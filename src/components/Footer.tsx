        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-semibold text-slate-900 text-sm">Parkinson Research</span>
            </div>
          ...
          {/* Links */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-slate-400 mb-4">Navigate</h4>
            <ul className="space-y-2.5">
              <li>
                <Link href={`/${lang}/reports`} className="text-sm text-slate-600 hover:text-primary transition-colors">
                  {t.allReports}
                </Link>
              </li>
              <li>
                <Link href={`/${lang}/resources`} className="text-sm text-slate-600 hover:text-primary transition-colors">
                  {t.resources}
                </Link>
              </li>
              <li>
                <Link href={`/${lang}/api/reports`} className="text-sm text-slate-600 hover:text-primary transition-colors">
                  {t.api}
                </Link>
              </li>
            </ul>
