    ...
    <div className="py-20 md:py-28 lg:py-32">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <header className="max-w-4xl mb-16">
          <h1
            className="font-display text-[clamp(2rem,5vw,3rem)] font-normal leading-[1.1] tracking-tight text-pap-text mb-4"
          >
            {t.title}
          </h1>
        </header>
        ...
        <div className="max-w-4xl space-y-6">
          ...
          <section className="border border-pap-border rounded-2xl p-6" style={{ padding: '1.75rem' }}>
            ...
            <ul className="space-y-2">
              {t.searchTargets.map((target, i) => (
                <li
                  key={i}
                  className="text-sm flex items-start gap-2 text-pap-muted"
                >
          ...
          <section className="border border-pap-border rounded-2xl p-6" style={{ padding: '1.75rem' }}>
            ...
            <ul className="space-y-2.5">
              {t.privacyItems.map((item, i) => (
                <li
                  key={i}
                  className="text-sm flex items-start gap-2.5 text-pap-muted"
                >
                  <span style={{ color: 'var(--pap-purple)' }}>—</span>
                  {item}
                </li>
          ...
          <section className="border border-pap-border rounded-2xl p-6" style={{ padding: '1.75rem' }}>
            <h2
              className="text-base font-semibold mb-4 flex items-center gap-3 text-pap-text"
            >
              <span
                className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0"
                style={{ background: 'var(--pap-purple-soft)' }}
          ...
          >
            ...
            >
              ...
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} style={{ color: 'var(--pap-lavender)' }}>
