      ...
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        ...
        {dates.length === 0 ? (
          <div className="border border-pap-border rounded-2xl p-6 text-center py-16" style={{ padding: '3rem' }}>
            ...
            <h3
              className="text-lg mb-2 font-display text-pap-text"
            >
              {t.noReports}
            </h3>
              ...
              return (
                <div key={date}>
                  <Link
                    ...
                    className="border border-pap-border rounded-2xl p-6 block transition-all duration-200 hover:border-pap-purple/30 hover:shadow-md"
                    style={{ padding: '1.375rem 1.5rem' }}
                  >
                    <div className="flex items-start sm:items-center justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        <h3
                          className="font-display text-pap-text"
                          style={{ fontSize: '1.0625rem' }}
                        >
                          {formatDate(date)}
                        </h3>
                        {meta?.preview && (
                          <p className="text-sm mt-1 line-clamp-1 text-pap-muted">
                            {meta.preview}
                          </p>
                        )}
                      </div>
